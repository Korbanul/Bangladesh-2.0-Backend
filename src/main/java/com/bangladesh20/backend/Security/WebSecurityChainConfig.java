...
//                .antMatchers("/admin/**").permitAll() // Match any auth sub-paths
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://bangladesh-20-production.up.railway.app","bangladesh-20-production-192a.up.railway.app")); //Two frontend url last one is updated with my gkislam email
